...
class _CombinedWaterScreenState extends State<CombinedWaterScreen> {
  ...
  late WaterQualityService _service;
 ...
 void _updateSensorData(Map<String, dynamic> data) {
    setState(() {
      waterParameters['pH']?['value'] = data['ph'];
      waterParameters['TDS']?['value'] = data['tds'];
      waterParameters['Turbidity']?['value'] = data['turbidity'];
      waterParameters['Temperature']?['value'] = data['temperature'];
